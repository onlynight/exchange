...
public class TranslateManager {
    ...
    private void createTranslator(String platform, String textType, String translatePath,
        ...
        if (translator == null) {
            TranslatePlatformPluginConfig platformConfig = TranslatorPluginManager.getInstance()
                    .getTranslatePlatformPlugins().get(platform);
            DocumentHandlerPluginConfig docConfig = TranslatorPluginManager.getInstance()
